            ...
            <div className='w-full h-full mx-auto relative'>
                ...
                <div className='z-20 bg-main-yellow w-full h-full'>
                    ...
                    <div className='md:max-w-7xl mx-auto w-full h-full flex flex-col justify-center p-4 z-30'>
                        ...
                        <h3 className='mt-2 font-interSemiBold md:text-4xl text-3xl text-black md:max-w-2xl z-30'>CRUISE PORT TRANSFERS FROM ONLY £105.00*</h3>
                ...
                <Image 
                    src="/images/banners/joseph-barrientos-eUMEWE-7Ewg-unsplash.jpg"
                    alt="Ship wheel"
                    fill={true}
