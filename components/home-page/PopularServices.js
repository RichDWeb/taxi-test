...
export const PopularServices = () => {
    return (
        <section className="bg-[#FAFAFA] w-full h-full py-10">
            ...
            <div className="w-full h-full max-w-7xl mx-auto flex flex-col justify-center">
                ...
                <div className='
                    ...
                    {/* Card 1 */}
                    <div className='md:w-full md:h-full xl:max-w-[400px] sbg-white rounded-md border my-4'>
                        ...
                        <div className='p-6'>
                            ...
                            <p className='font-interRegular text-zinc-600 leading-7 mt-3 xl:max-w-[300px] w-full'>Local Cabs provide airport travel to and from Wales and England airports such as 
                    ...
                    {/* Card 2 */}
                    <div className='md:w-full md:h-full xl:max-w-[400px] bg-white rounded-md border my-4'>
                        <div className='relative w-full h-[210px] overflow-hidden cursor-pointer '>
                            <Image 
                        ...
                        <div className='py-6 px-8'>
                            ...
                            <p className='font-interRegular text-zinc-600 leading-7 mt-3 xl:max-w-[300px] w-full'>Local Cabs are based in the 
                    ...
                    <div className='md:w-full md:h-full xl:max-w-[400px] bg-white rounded-md border my-4'>
                        ...
                        <div className='p-6'>
                            ...
                            <p className='font-interRegular text-zinc-600 leading-7 mt-3 xl:max-w-[300px] w-full'>Local Cabs can transport you 
